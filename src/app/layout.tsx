    ...
    <html lang="pt-br">
      <body className={inter.className}>
        <button
          ...
          type="button"
          className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-emerald-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-emerald-700 dark:focus:ring-gray-600"
        >
          ...
          <div className="h-full px-3 py-4 overflow-y-auto bg-emerald-50 dark:bg-emerald-800">
            <ul className="space-y-2 font-medium">
              <li>
                <Link
                  href="/plantas"
                  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-emerald-100 dark:hover:bg-emerald-700 group"
                >
                  <svg
